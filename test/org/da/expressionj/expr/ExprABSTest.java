...
public class ExprABSTest {
    ...
    /**
     * Test of eval method, of class ExprABS.
     */
    @Test
    public void testEval() {
        System.out.println("evalABS");
        try {
            Equation condition = EquationParser.parse("abs(a)");
            ...
            assertEquals("Result must be 2", 2, value, 0.00001f);

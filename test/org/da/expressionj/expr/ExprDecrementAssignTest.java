...
/** Unit tests for the decrement and assign (-=) operator.
 *
 * @since 0.9
 */
public class ExprDecrementAssignTest {
   public ExprDecrementAssignTest() {
   }
    ...
    */
   @Test
   public void testEvalDecrementAssign() {
      System.out.println("evalDecrementAssign");
      try {
         ...
         assertEquals("a value must be -1", -1, var.getValue());

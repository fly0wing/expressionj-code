 ...
 * @version 0.10
 */
public class ExprOR extends AbstractAryExpression {
   public ExprOR() {
   }
   
   @Override
   public Object clone() throws CloneNotSupportedException {
      ExprOR or = new ExprOR();
   ...
   public final boolean evalAsBoolean() {
      ...
      // by doing this we ensure that we only test the first part of the expression if it is already true
      if (value2) {
         return true;
      }
      if (expr1 != null) {
